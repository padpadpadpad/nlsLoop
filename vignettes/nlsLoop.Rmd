...
Where $k$ is Boltzmann's constant $8.62e^{-5}$ and $T$ is temperature in Kelvin. A detailed explanation of the other parameters model can be found here (Padfield _et. al_ 2016)[http://onlinelibrary.wiley.com/doi/10.1111/ele.12545/epdf]. 
